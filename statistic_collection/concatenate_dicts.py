...
plot_scatterplot(S_list, m_list, 'Number of mismatched bits', basedir + 'mismatch_spread.png')
plot_scatterplot(S_list, p_list, 'Position of true binary on sorted binaries list', basedir + 'position_spread.png')
plot_scatterplot(S_list, c_list, 'Number of correct binary number guesses', basedir + 'is_correct_spread.png')
