			...
			for line in infile:
				stripline = line.strip('\n')
	        	        line_dict = ast.literal_eval(stripline)
                                if float(line_dict["Posterior"]) > 0.90:
					#print(line_dict)
...
pt.plot_scatterplot(all_mismatch, all_SNR, [-1,np.amax(all_mismatch) + 1], 'Number of incorrect chunks', basedir + 'mismatch_spread.png')
