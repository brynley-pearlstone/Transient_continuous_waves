...
#	print(args_to_write)
#	outtext.write  ('--detectors H1,L1 --par-file ' + par_path + ' --input-files ' + directory + 'H1/' + (H1_chunks[item]) + ',' + directory + 'L1/' + (L1_chunks[item]) + ' --outfile ' + directory + (H1_chunks[item][27:-3]) + 'hdf --Nlive 1024 --Nmcmcinitial 0 --tolerance 0.1 --prior-file ' + prior_path + '\n' )
