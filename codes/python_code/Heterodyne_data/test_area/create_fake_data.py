...
parser.add_argument('-s', '--random_seed', dest = 'random_seed',
                  help = 'Random seed used to generate noise', default = '', metavar = 'FLOAT')
