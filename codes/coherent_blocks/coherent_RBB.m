...
scale = ones(size(sorted_odds(end-to_plot:end))).*((sorted_odds(end-to_plot:end))./((sorted_odds(end))));

scaled_binaries = (sorted_binaries(end-to_plot:end)-0.5)*2;

for configuration = 1:length(sorted_odds(end-to_plot:end))
